...
def test_get_projects_by_team(client):
    ...
    assert "Test" in [project.name for project in scl_team.projects]


def test_get_project_name(client):
    project_name = get_project_name(client, "30a0f293-6732-4f47-8286-39d3771e1824")
    assert project_name == "Test"


def test_get_project_issue_diagram(client):
    diagram = get_project_issue_diagram(client, "30a0f293-6732-4f47-8286-39d3771e1824")
    assert (
        diagram
        == r"""flowchart LR
